...
def login():
    if current_user.is_authenticated:
        return redirect(url_for('index'))  # redirect to index page if the user is logged in
    form = LoginForm()
    if form.validate_on_submit():
        ...
        next_page = request.args.get('next')  # redirect user to index page after logging in
...
# user profile page (with dynamic component)
